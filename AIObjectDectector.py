...
EMOJI = {"person": "🧍", "car": "🚗", "truck": "🛻", "bus": "🚌", "bicycle": "🚲", "motorcycle": "🏍️", "dog": "🐶", "cat": "😺", "bird": "🐦", "horse": "🐴", "sheep": "🐑", "cow": "🐮", "bear": "🐻", "giraffe": "🦒", "zebra": "🦓", "banana": "🍌", "apple": "🍏", "orange": "🍊", "pizza": "🍕", "broccolli": "🥦", "book": "📕", "laptop": "💻", "tv": "📺", "bottle": "🍼", "cup": "☕"}
...
def main():
    ...
    if counts:
        ...
        print("\n⚠️ Disclaimer: This is an AI demo. "
