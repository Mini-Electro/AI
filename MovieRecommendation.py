...
try: df = pd.read_csv("E://Users//User//Downloads//imdb_top_1000 (1).csv")
...
def senti(p): return "Positive ☺️" if p > 0 else "Negative 😔" if p < 0 else "Neutral 😐"
...
def get_genre():
    ...
    while True:
        ...
        print(Fore.RED + "Invaild input. Try again.\n")
...
md = "positive ☺️" if mp > 0 else "negative 😔" if mp < 0 else "neutral 😐"
...
while True:
    ...
    if a == "yes":
        ...
        print(Fore.RED + "Invaild choice. Try again!")