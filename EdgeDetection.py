...
def interactive_edge_detection(image_path):
    ...
    while True:
        ...
        if choice == "1":
            ...
            display_image("Sobel Edge Direction", combined_sobel)
            ...
            display_image("Canny Detection", edges)
...
interactive_edge_detection("C://Users//ADMIN//Downloads//Image_annotation_AIEPCM2L3A1-3dd2//example.jpg")