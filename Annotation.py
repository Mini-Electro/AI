...
image_path = "C://Users//ADMIN//Downloads//Image_annotation_AIEPCM2L3A1-3dd2//example.jpg"
...
cv2.putText(image_rgb, "Region 1", (topleft1[0], topleft1[1] - 10), font, 0.7, (255,255,255), 2, cv2.LINE_AA)
cv2.putText(image_rgb, "Region 2", (topleft2[0], topleft2[1] - 10), font, 0.7, (255,255,255), 2, cv2.LINE_AA)
...
plt.title("Annonated Image With Regions, Centers, and Bi-Directional Height Arrow")
plt.axis("off")
plt.show()